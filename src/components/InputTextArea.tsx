...
interface IInputTextArea extends IInputTextAreaEle {
  value?: string;
  defaultValue?: string;
  placeholder?: string;
  noResize?: boolean;
...
const InputTextArea = forwardRef< HTMLTextAreaElement, IInputTextArea>((
  {
    value, 
    defaultValue, 
    noResize, 
...
export const InputTextAreaEle = styled.textarea<IInputTextAreaEle>`  //["attrs"]
